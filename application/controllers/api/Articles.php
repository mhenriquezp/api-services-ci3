...
class Articles extends \Restserver\Libraries\REST_Controller
{
    ...
    /**
     * Read an Articles with API
     * @method: GET
     */
    public function readArticle_get()
    {
        header("Access-Control-Allow-Origin: *");
        ...
        if (!empty($is_valid_token) AND $is_valid_token['status'] === TRUE)
        {
            # Read a Users Article

            $this->load->model('article_model', 'ArticleModel');

            $output = $this->ArticleModel->read_article();
    ...
    /**
     * Read an Article by Id with API
     * @method: GET
     */
    public function searchArticle_get($id)
    {
        header("Access-Control-Allow-Origin: *");
        ...
        if (!empty($is_valid_token) AND $is_valid_token['status'] === TRUE)
        {
            ...
            else
            {
                ...
                // Search an Article
                $output = $this->ArticleModel->search_article($id);
     ...
     * @method: GET
     */
    public function post_searchArticle_post()
    {
        header("Access-Control-Allow-Origin: *");
        ...
        if (!empty($is_valid_token) AND $is_valid_token['status'] === TRUE)
        {
            ...
            // {
                ...
                // Search an Article
                $output = $this->ArticleModel->search_article($_POST["id"]);
