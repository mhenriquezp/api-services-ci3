...
// Read Article Routes
$route['api/article/read'] = 'api/articles/readArticle';

// Search Article Routes
$route['api/article/search/(:num)'] = 'api/articles/searchArticle/$1';

// Search Article Routes
$route['api/article/post_search'] = 'api/articles/post_searchArticle';
